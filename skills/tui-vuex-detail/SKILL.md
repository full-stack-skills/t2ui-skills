---
name: tui-vuex-detail
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Vuex Detail (u-vuex-detail) with strict output blocks (TUI_RENDER, COMPONENT_SPEC, PENCIL_SPEC, PENCIL_BATCH_DESIGN) suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Vuex Detail**.
...
- `full-stack-skills/tui-sources/components.json` (lookup by `skill=tui-vuex-detail` or `slug=vuex-detail`)
...
```json
{
  "id": "tui-vuex-detail_1",
  "name": "Vuex Detail",
  "type": "tui-vuex-detail",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Vuex Detail/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Vuex Detail/Text",content:"Vuex Detail"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-vuex-detail_ex1", "name": "Vuex Detail", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-vuex-detail_ex2", "name": "Vuex Detail", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-vuex-detail_ex3", "name": "Vuex Detail", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Vuex Detail/Error",content:"Error: Something went wrong…"})
...
| tui-vuex-detail | Vuex Detail | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
