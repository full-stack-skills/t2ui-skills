...
name: tui-link
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Link u-link with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Link**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-link_ex1", "name": "Link", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-link_ex2", "name": "Link", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-link_ex3", "name": "Link", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Link/Error",content:"Error: Something went wrong…"})
...
| tui-link | Link | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
