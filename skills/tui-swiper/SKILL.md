...
name: tui-swiper
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Swiper u-swiper with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Swiper**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-swiper_ex1", "name": "Swiper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-swiper_ex2", "name": "Swiper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-swiper_ex3", "name": "Swiper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Swiper/Error",content:"Error: Something went wrong…"})
...
| tui-swiper | Swiper | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
