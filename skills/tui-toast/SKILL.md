...
name: tui-toast
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Toast u-toast with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Toast**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-toast_ex1", "name": "Toast", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-toast_ex2", "name": "Toast", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-toast_ex3", "name": "Toast", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Toast/Error",content:"Error: Something went wrong…"})
...
| tui-toast | Toast | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
