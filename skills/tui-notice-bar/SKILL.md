...
name: tui-notice-bar
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Notice Bar u-notice-bar with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Notice Bar**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Notice Bar/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Notice Bar/Text",content:"Notice Bar"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-notice-bar_ex1", "name": "Notice Bar", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-notice-bar_ex2", "name": "Notice Bar", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-notice-bar_ex3", "name": "Notice Bar", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Notice Bar/Error",content:"Error: Something went wrong…"})
...
| tui-notice-bar | Notice Bar | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
