---
name: tui-safe-area-inset
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Safe Area Inset u-safe-area-inset with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Safe Area Inset**.
...
```json
{
  "id": "tui-safe-area-inset_1",
  "name": "Safe Area Inset",
  "type": "tui-safe-area-inset",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Safe Area Inset/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Safe Area Inset/Text",content:"Safe Area Inset"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-safe-area-inset_ex1", "name": "Safe Area Inset", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-safe-area-inset_ex2", "name": "Safe Area Inset", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-safe-area-inset_ex3", "name": "Safe Area Inset", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Safe Area Inset/Error",content:"Error: Something went wrong…"})
...
| tui-safe-area-inset | Safe Area Inset | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
