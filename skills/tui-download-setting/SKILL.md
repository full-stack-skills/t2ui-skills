---
name: tui-download-setting
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Download Setting (u-download-setting) with strict output blocks (TUI_RENDER, COMPONENT_SPEC, PENCIL_SPEC, PENCIL_BATCH_DESIGN) suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Download Setting**.
...
- `full-stack-skills/tui-sources/components.json` (lookup by `skill=tui-download-setting` or `slug=download-setting`)
...
```json
{
  "id": "tui-download-setting_1",
  "name": "Download Setting",
  "type": "tui-download-setting",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Download Setting/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Download Setting/Text",content:"Download Setting"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-download-setting_ex1", "name": "Download Setting", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-download-setting_ex2", "name": "Download Setting", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-download-setting_ex3", "name": "Download Setting", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Download Setting/Error",content:"Error: Something went wrong…"})
...
| tui-download-setting | Download Setting | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
