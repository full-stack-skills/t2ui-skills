...
name: tui-fab
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Fab u-fab with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Fab**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-fab_ex1", "name": "Fab", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-fab_ex2", "name": "Fab", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-fab_ex3", "name": "Fab", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Fab/Error",content:"Error: Something went wrong…"})
...
| tui-fab | Fab | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
