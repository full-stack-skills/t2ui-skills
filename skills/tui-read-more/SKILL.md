...
- Produce an ASCII Text UI (TUI) representation of **Read More**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Read More/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Read More/Text",content:"Read More"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-read-more_ex1", "name": "Read More", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-read-more_ex2", "name": "Read More", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-read-more_ex3", "name": "Read More", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Read More/Error",content:"Error: Something went wrong…"})
...
| tui-read-more | Read More | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
