...
name: tui-chat-group
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Chat Group (u-chat-group) with strict output blocks (TUI_RENDER, COMPONENT_SPEC, PENCIL_SPEC, PENCIL_BATCH_DESIGN) suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Chat Group**.
...
- `full-stack-skills/tui-sources/components.json` (lookup by `skill=tui-chat-group` or `slug=chat-group`)
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Chat Group/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Chat Group/Text",content:"Chat Group"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-chat-group_ex1", "name": "Chat Group", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-chat-group_ex2", "name": "Chat Group", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-chat-group_ex3", "name": "Chat Group", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Chat Group/Error",content:"Error: Something went wrong…"})
...
| tui-chat-group | Chat Group | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
