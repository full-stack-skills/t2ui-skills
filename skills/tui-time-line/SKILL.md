...
name: tui-time-line
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Time Line u-time-line with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Time Line**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Time Line/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Time Line/Text",content:"Time Line"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-time-line_ex1", "name": "Time Line", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-time-line_ex2", "name": "Time Line", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-time-line_ex3", "name": "Time Line", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Time Line/Error",content:"Error: Something went wrong…"})
...
| tui-time-line | Time Line | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
