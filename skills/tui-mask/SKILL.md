...
name: tui-mask
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Mask u-mask with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Mask**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-mask_ex1", "name": "Mask", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-mask_ex2", "name": "Mask", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-mask_ex3", "name": "Mask", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Mask/Error",content:"Error: Something went wrong…"})
...
| tui-mask | Mask | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
