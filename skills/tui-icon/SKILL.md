...
name: tui-icon
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Icon u-icon with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Icon**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-icon_ex1", "name": "Icon", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-icon_ex2", "name": "Icon", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-icon_ex3", "name": "Icon", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Icon/Error",content:"Error: Something went wrong…"})
...
| tui-icon | Icon | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
