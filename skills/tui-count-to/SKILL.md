...
name: tui-count-to
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Count To u-count-to with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Count To**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Count To/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Count To/Text",content:"Count To"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-count-to_ex1", "name": "Count To", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-count-to_ex2", "name": "Count To", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-count-to_ex3", "name": "Count To", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Count To/Error",content:"Error: Something went wrong…"})
...
| tui-count-to | Count To | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
