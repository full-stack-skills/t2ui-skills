---
name: tui-swipe-action
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Swipe Action u-swipe-action with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Swipe Action**.
...
```json
{
  "id": "tui-swipe-action_1",
  "name": "Swipe Action",
  "type": "tui-swipe-action",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Swipe Action/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Swipe Action/Text",content:"Swipe Action"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-swipe-action_ex1", "name": "Swipe Action", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-swipe-action_ex2", "name": "Swipe Action", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-swipe-action_ex3", "name": "Swipe Action", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Swipe Action/Error",content:"Error: Something went wrong…"})
...
| tui-swipe-action | Swipe Action | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
