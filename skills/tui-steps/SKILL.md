...
name: tui-steps
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Steps u-steps with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Steps**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-steps_ex1", "name": "Steps", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-steps_ex2", "name": "Steps", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-steps_ex3", "name": "Steps", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Steps/Error",content:"Error: Something went wrong…"})
...
| tui-steps | Steps | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
