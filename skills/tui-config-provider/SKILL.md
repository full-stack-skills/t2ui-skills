---
name: tui-config-provider
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Config Provider u-config-provider with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Config Provider**.
...
```json
{
  "id": "tui-config-provider_1",
  "name": "Config Provider",
  "type": "tui-config-provider",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Config Provider/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Config Provider/Text",content:"Config Provider"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-config-provider_ex1", "name": "Config Provider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-config-provider_ex2", "name": "Config Provider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-config-provider_ex3", "name": "Config Provider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Config Provider/Error",content:"Error: Something went wrong…"})
...
| tui-config-provider | Config Provider | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
