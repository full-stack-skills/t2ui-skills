---
name: tui-avatar-cropper
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Avatar Cropper (u-avatar-cropper) with strict output blocks (TUI_RENDER, COMPONENT_SPEC, PENCIL_SPEC, PENCIL_BATCH_DESIGN) suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Avatar Cropper**.
...
- `full-stack-skills/tui-sources/components.json` (lookup by `skill=tui-avatar-cropper` or `slug=avatar-cropper`)
...
```json
{
  "id": "tui-avatar-cropper_1",
  "name": "Avatar Cropper",
  "type": "tui-avatar-cropper",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Avatar Cropper/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Avatar Cropper/Text",content:"Avatar Cropper"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-avatar-cropper_ex1", "name": "Avatar Cropper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-avatar-cropper_ex2", "name": "Avatar Cropper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-avatar-cropper_ex3", "name": "Avatar Cropper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Avatar Cropper/Error",content:"Error: Something went wrong…"})
...
| tui-avatar-cropper | Avatar Cropper | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
