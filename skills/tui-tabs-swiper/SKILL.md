---
name: tui-tabs-swiper
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Tabs Swiper u-tabs-swiper with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Tabs Swiper**.
...
```json
{
  "id": "tui-tabs-swiper_1",
  "name": "Tabs Swiper",
  "type": "tui-tabs-swiper",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Tabs Swiper/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Tabs Swiper/Text",content:"Tabs Swiper"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tabs-swiper_ex1", "name": "Tabs Swiper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tabs-swiper_ex2", "name": "Tabs Swiper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tabs-swiper_ex3", "name": "Tabs Swiper", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Tabs Swiper/Error",content:"Error: Something went wrong…"})
...
| tui-tabs-swiper | Tabs Swiper | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
