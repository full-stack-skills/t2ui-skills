...
name: tui-slider
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Slider u-slider with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Slider**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-slider_ex1", "name": "Slider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-slider_ex2", "name": "Slider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-slider_ex3", "name": "Slider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Slider/Error",content:"Error: Something went wrong…"})
...
| tui-slider | Slider | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
