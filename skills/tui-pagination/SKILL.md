...
name: tui-pagination
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Pagination u-pagination with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Pagination**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Pagination/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Pagination/Text",content:"Pagination"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-pagination_ex1", "name": "Pagination", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-pagination_ex2", "name": "Pagination", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-pagination_ex3", "name": "Pagination", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Pagination/Error",content:"Error: Something went wrong…"})
...
| tui-pagination | Pagination | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
