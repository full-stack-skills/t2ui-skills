...
name: tui-tabbar
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Tabbar u-tabbar with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Tabbar**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tabbar_ex1", "name": "Tabbar", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tabbar_ex2", "name": "Tabbar", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tabbar_ex3", "name": "Tabbar", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Tabbar/Error",content:"Error: Something went wrong…"})
...
| tui-tabbar | Tabbar | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
