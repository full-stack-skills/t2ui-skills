...
name: tui-picker
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Picker u-picker with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Picker**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-picker_ex1", "name": "Picker", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-picker_ex2", "name": "Picker", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-picker_ex3", "name": "Picker", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Picker/Error",content:"Error: Something went wrong…"})
...
| tui-picker | Picker | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
