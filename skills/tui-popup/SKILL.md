...
name: tui-popup
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Popup u-popup with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Popup**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-popup_ex1", "name": "Popup", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-popup_ex2", "name": "Popup", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-popup_ex3", "name": "Popup", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Popup/Error",content:"Error: Something went wrong…"})
...
| tui-popup | Popup | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
