...
name: tui-color
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Color u-color with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Color**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-color_ex1", "name": "Color", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-color_ex2", "name": "Color", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-color_ex3", "name": "Color", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Color/Error",content:"Error: Something went wrong…"})
...
| tui-color | Color | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
