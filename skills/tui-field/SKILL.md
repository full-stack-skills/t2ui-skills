...
- Produce an ASCII Text UI (TUI) representation of **Field**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-field_ex1", "name": "Field", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-field_ex2", "name": "Field", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-field_ex3", "name": "Field", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Field/Error",content:"Error: Something went wrong…"})
...
| tui-field | Field | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
