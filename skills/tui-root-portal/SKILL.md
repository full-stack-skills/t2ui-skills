---
name: tui-root-portal
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Root Portal u-root-portal with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Root Portal**.
...
```json
{
  "id": "tui-root-portal_1",
  "name": "Root Portal",
  "type": "tui-root-portal",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Root Portal/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Root Portal/Text",content:"Root Portal"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-root-portal_ex1", "name": "Root Portal", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-root-portal_ex2", "name": "Root Portal", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-root-portal_ex3", "name": "Root Portal", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Root Portal/Error",content:"Error: Something went wrong…"})
...
| tui-root-portal | Root Portal | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
