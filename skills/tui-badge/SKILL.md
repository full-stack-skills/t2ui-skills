...
name: tui-badge
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Badge u-badge with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Badge**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-badge_ex1", "name": "Badge", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-badge_ex2", "name": "Badge", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-badge_ex3", "name": "Badge", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Badge/Error",content:"Error: Something went wrong…"})
...
| tui-badge | Badge | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
