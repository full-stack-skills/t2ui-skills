...
name: tui-number-box
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Number Box u-number-box with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Number Box**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Number Box/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Number Box/Text",content:"Number Box"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-number-box_ex1", "name": "Number Box", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-number-box_ex2", "name": "Number Box", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-number-box_ex3", "name": "Number Box", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Number Box/Error",content:"Error: Something went wrong…"})
...
| tui-number-box | Number Box | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
