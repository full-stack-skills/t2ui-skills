...
name: tui-quickstart
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Quickstart (u-quickstart) with strict output blocks (TUI_RENDER, COMPONENT_SPEC, PENCIL_SPEC, PENCIL_BATCH_DESIGN) suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Quickstart**.
...
- `full-stack-skills/tui-sources/components.json` (lookup by `skill=tui-quickstart` or `slug=quickstart`)
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Quickstart/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Quickstart/Text",content:"Quickstart"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-quickstart_ex1", "name": "Quickstart", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-quickstart_ex2", "name": "Quickstart", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-quickstart_ex3", "name": "Quickstart", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Quickstart/Error",content:"Error: Something went wrong…"})
...
| tui-quickstart | Quickstart | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
