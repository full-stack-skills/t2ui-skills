...
name: tui-lazy-load
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Lazy Load u-lazy-load with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Lazy Load**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Lazy Load/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Lazy Load/Text",content:"Lazy Load"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-lazy-load_ex1", "name": "Lazy Load", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-lazy-load_ex2", "name": "Lazy Load", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-lazy-load_ex3", "name": "Lazy Load", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Lazy Load/Error",content:"Error: Something went wrong…"})
...
| tui-lazy-load | Lazy Load | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
