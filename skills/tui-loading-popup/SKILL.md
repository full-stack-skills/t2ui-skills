---
name: tui-loading-popup
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Loading Popup u-loading-popup with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Loading Popup**.
...
```json
{
  "id": "tui-loading-popup_1",
  "name": "Loading Popup",
  "type": "tui-loading-popup",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Loading Popup/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Loading Popup/Text",content:"Loading Popup"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-loading-popup_ex1", "name": "Loading Popup", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-loading-popup_ex2", "name": "Loading Popup", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-loading-popup_ex3", "name": "Loading Popup", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Loading Popup/Error",content:"Error: Something went wrong…"})
...
| tui-loading-popup | Loading Popup | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
