---
name: tui-verification-code
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Verification Code u-verification-code with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Verification Code**.
...
```json
{
  "id": "tui-verification-code_1",
  "name": "Verification Code",
  "type": "tui-verification-code",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Verification Code/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Verification Code/Text",content:"Verification Code"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-verification-code_ex1", "name": "Verification Code", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-verification-code_ex2", "name": "Verification Code", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-verification-code_ex3", "name": "Verification Code", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Verification Code/Error",content:"Error: Something went wrong…"})
...
| tui-verification-code | Verification Code | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
