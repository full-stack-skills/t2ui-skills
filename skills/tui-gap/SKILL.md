...
name: tui-gap
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Gap u-gap with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Gap**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-gap_ex1", "name": "Gap", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-gap_ex2", "name": "Gap", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-gap_ex3", "name": "Gap", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Gap/Error",content:"Error: Something went wrong…"})
...
| tui-gap | Gap | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
