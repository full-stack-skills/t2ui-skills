...
name: tui-collapse
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Collapse u-collapse with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Collapse**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Collapse/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Collapse/Text",content:"Collapse"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-collapse_ex1", "name": "Collapse", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-collapse_ex2", "name": "Collapse", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-collapse_ex3", "name": "Collapse", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Collapse/Error",content:"Error: Something went wrong…"})
...
| tui-collapse | Collapse | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
