...
name: tui-tag
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Tag u-tag with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Tag**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tag_ex1", "name": "Tag", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tag_ex2", "name": "Tag", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-tag_ex3", "name": "Tag", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Tag/Error",content:"Error: Something went wrong…"})
...
| tui-tag | Tag | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
