...
name: tui-divider
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Divider u-divider with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Divider**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Divider/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Divider/Text",content:"Divider"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-divider_ex1", "name": "Divider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-divider_ex2", "name": "Divider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-divider_ex3", "name": "Divider", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Divider/Error",content:"Error: Something went wrong…"})
...
| tui-divider | Divider | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
