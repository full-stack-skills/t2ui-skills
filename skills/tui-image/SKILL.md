...
name: tui-image
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Image u-image with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Image**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-image_ex1", "name": "Image", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-image_ex2", "name": "Image", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-image_ex3", "name": "Image", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Image/Error",content:"Error: Something went wrong…"})
...
| tui-image | Image | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
