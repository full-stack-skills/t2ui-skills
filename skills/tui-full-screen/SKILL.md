---
name: tui-full-screen
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Full Screen u-full-screen with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Full Screen**.
...
```json
{
  "id": "tui-full-screen_1",
  "name": "Full Screen",
  "type": "tui-full-screen",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Full Screen/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Full Screen/Text",content:"Full Screen"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-full-screen_ex1", "name": "Full Screen", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-full-screen_ex2", "name": "Full Screen", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-full-screen_ex3", "name": "Full Screen", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Full Screen/Error",content:"Error: Something went wrong…"})
...
| tui-full-screen | Full Screen | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
