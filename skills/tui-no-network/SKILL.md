...
name: tui-no-network
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for No Network u-no-network with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **No Network**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"No Network/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"No Network/Text",content:"No Network"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-no-network_ex1", "name": "No Network", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-no-network_ex2", "name": "No Network", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-no-network_ex3", "name": "No Network", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"No Network/Error",content:"Error: Something went wrong…"})
...
| tui-no-network | No Network | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
