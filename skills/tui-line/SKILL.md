...
name: tui-line
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Line u-line with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Line**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-line_ex1", "name": "Line", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-line_ex2", "name": "Line", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-line_ex3", "name": "Line", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Line/Error",content:"Error: Something went wrong…"})
...
| tui-line | Line | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
