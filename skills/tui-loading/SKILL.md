...
name: tui-loading
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Loading u-loading with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Loading**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Loading/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Loading/Text",content:"Loading"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-loading_ex1", "name": "Loading", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-loading_ex2", "name": "Loading", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-loading_ex3", "name": "Loading", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Loading/Error",content:"Error: Something went wrong…"})
...
| tui-loading | Loading | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
