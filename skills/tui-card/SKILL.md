...
name: tui-card
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Card u-card with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Card**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-card_ex1", "name": "Card", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-card_ex2", "name": "Card", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-card_ex3", "name": "Card", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Card/Error",content:"Error: Something went wrong…"})
...
| tui-card | Card | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
