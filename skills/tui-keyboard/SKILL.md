...
name: tui-keyboard
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Keyboard u-keyboard with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Keyboard**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Keyboard/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Keyboard/Text",content:"Keyboard"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-keyboard_ex1", "name": "Keyboard", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-keyboard_ex2", "name": "Keyboard", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-keyboard_ex3", "name": "Keyboard", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Keyboard/Error",content:"Error: Something went wrong…"})
...
| tui-keyboard | Keyboard | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
