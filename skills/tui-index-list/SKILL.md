...
name: tui-index-list
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Index List u-index-list with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Index List**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Index List/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Index List/Text",content:"Index List"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-index-list_ex1", "name": "Index List", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-index-list_ex2", "name": "Index List", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-index-list_ex3", "name": "Index List", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Index List/Error",content:"Error: Something went wrong…"})
...
| tui-index-list | Index List | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
