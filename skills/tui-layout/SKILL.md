...
name: tui-layout
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Layout u-layout with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Layout**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-layout_ex1", "name": "Layout", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-layout_ex2", "name": "Layout", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-layout_ex3", "name": "Layout", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Layout/Error",content:"Error: Something went wrong…"})
...
| tui-layout | Layout | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
