---
name: tui-message-input
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Message Input u-message-input with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Message Input**.
...
```json
{
  "id": "tui-message-input_1",
  "name": "Message Input",
  "type": "tui-message-input",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Message Input/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Message Input/Text",content:"Message Input"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-message-input_ex1", "name": "Message Input", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-message-input_ex2", "name": "Message Input", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-message-input_ex3", "name": "Message Input", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Message Input/Error",content:"Error: Something went wrong…"})
...
| tui-message-input | Message Input | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
