...
name: tui-empty
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Empty u-empty with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Empty**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-empty_ex1", "name": "Empty", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-empty_ex2", "name": "Empty", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-empty_ex3", "name": "Empty", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Empty/Error",content:"Error: Something went wrong…"})
...
| tui-empty | Empty | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
