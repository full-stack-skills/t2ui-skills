...
name: tui-search
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Search u-search with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Search**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-search_ex1", "name": "Search", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-search_ex2", "name": "Search", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-search_ex3", "name": "Search", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Search/Error",content:"Error: Something went wrong…"})
...
| tui-search | Search | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
