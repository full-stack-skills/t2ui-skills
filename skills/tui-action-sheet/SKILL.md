---
name: tui-action-sheet
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Action Sheet u-action-sheet with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Action Sheet**.
...
```json
{
  "id": "tui-action-sheet_1",
  "name": "Action Sheet",
  "type": "tui-action-sheet",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Action Sheet/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Action Sheet/Text",content:"Action Sheet"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-action-sheet_ex1", "name": "Action Sheet", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-action-sheet_ex2", "name": "Action Sheet", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-action-sheet_ex3", "name": "Action Sheet", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Action Sheet/Error",content:"Error: Something went wrong…"})
...
| tui-action-sheet | Action Sheet | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
