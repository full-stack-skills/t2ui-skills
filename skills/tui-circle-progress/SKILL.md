---
name: tui-circle-progress
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Circle Progress u-circle-progress with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Circle Progress**.
...
```json
{
  "id": "tui-circle-progress_1",
  "name": "Circle Progress",
  "type": "tui-circle-progress",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Circle Progress/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Circle Progress/Text",content:"Circle Progress"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-circle-progress_ex1", "name": "Circle Progress", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-circle-progress_ex2", "name": "Circle Progress", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-circle-progress_ex3", "name": "Circle Progress", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Circle Progress/Error",content:"Error: Something went wrong…"})
...
| tui-circle-progress | Circle Progress | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
