...
- Produce an ASCII Text UI (TUI) representation of **Line Progress**.
...
```json
{
  "id": "tui-line-progress_1",
  "name": "Line Progress",
  "type": "tui-line-progress",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Line Progress/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Line Progress/Text",content:"Line Progress"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-line-progress_ex1", "name": "Line Progress", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-line-progress_ex2", "name": "Line Progress", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-line-progress_ex3", "name": "Line Progress", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Line Progress/Error",content:"Error: Something went wrong…"})
...
| tui-line-progress | Line Progress | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
