...
name: tui-count-down
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Count Down u-count-down with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Count Down**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Count Down/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Count Down/Text",content:"Count Down"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-count-down_ex1", "name": "Count Down", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-count-down_ex2", "name": "Count Down", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-count-down_ex3", "name": "Count Down", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Count Down/Error",content:"Error: Something went wrong…"})
...
| tui-count-down | Count Down | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
