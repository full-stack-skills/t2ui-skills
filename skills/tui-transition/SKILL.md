...
name: tui-transition
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Transition u-transition with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Transition**.
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Transition/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Transition/Text",content:"Transition"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-transition_ex1", "name": "Transition", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-transition_ex2", "name": "Transition", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-transition_ex3", "name": "Transition", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Transition/Error",content:"Error: Something went wrong…"})
...
| tui-transition | Transition | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
