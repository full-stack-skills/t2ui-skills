---
name: tui-npm-setting
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Npm Setting (u-npm-setting) with strict output blocks (TUI_RENDER, COMPONENT_SPEC, PENCIL_SPEC, PENCIL_BATCH_DESIGN) suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Npm Setting**.
...
- `full-stack-skills/tui-sources/components.json` (lookup by `skill=tui-npm-setting` or `slug=npm-setting`)
...
```json
{
  "id": "tui-npm-setting_1",
  "name": "Npm Setting",
  "type": "tui-npm-setting",
...
CALL 2:
cmpBg=I(screen,{type:"rect",name:"Npm Setting/Background"})
U(cmpBg,{x:24,y:24,width:342,height:96,fillColor:"#ffffff",strokeColor:"#e5e7eb",strokeThickness:1,cornerRadius:12})
cmpText=I(screen,{type:"text",name:"Npm Setting/Text",content:"Npm Setting"})
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-npm-setting_ex1", "name": "Npm Setting", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-npm-setting_ex2", "name": "Npm Setting", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-npm-setting_ex3", "name": "Npm Setting", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Npm Setting/Error",content:"Error: Something went wrong…"})
...
| tui-npm-setting | Npm Setting | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
