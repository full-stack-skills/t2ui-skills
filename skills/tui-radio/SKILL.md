...
name: tui-radio
license: Apache-2.0
description: Generate pixel-precise ASCII TUI for Radio u-radio with strict output blocks TUI_RENDER COMPONENT_SPEC PENCIL_SPEC PENCIL_BATCH_DESIGN suitable for Pencil MCP drawing workflows.
---


## Purpose

- Produce an ASCII Text UI (TUI) representation of **Radio**.
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-radio_ex1", "name": "Radio", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 96 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-radio_ex2", "name": "Radio", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 104 }, "zIndex": 1 }
  ]
}
```
...
```json
{
  ...
  "nodes": [],
  "components": [
    { "id": "tui-radio_ex3", "name": "Radio", "bbox": { "topPx": 24, "leftPx": 24, "widthPx": 342, "heightPx": 112 }, "zIndex": 1 }
  ]
}
```
...
cmpText=I(screen,{type:"text",name:"Radio/Error",content:"Error: Something went wrong…"})
...
| tui-radio | Radio | 0 | 0 | 0 | 0 | 0 | keyProps=... | state=... | hotkeys=... |
```
